export type Duration = 1 | 2 | 4 | 8 | 12;
...
export type MelodyNote = readonly [Pitch, Duration];
...
export type MelodyTransformation = readonly [Melodies, Scale, Tempo];
...
export type Unpacked = readonly [Pitch[], Duration[]];

export type UnpackingFunction = (packedMelody: Melody) => Unpacked;

export type PackingFunction = (pitches: Pitch[], durations: Duration[]) => Melody;

export type MelodySingleTransformation = (p: Pitch[], r: Duration[]) => Unpacked;
